...
export const WEAPONS: WeaponDef[] = [
  { id: 'repeater', name: 'Pulse Repeater', tagline: 'RAPID FIRE', description: 'A relentless single stream. High fire rate, precise aim, excellent with on-hit effects.', color: '#a4ffcc', interval: .058, damage: 1.26, speed: 95, pellets: 1, spread: 0, lifetime: 1.6, radius: .22 },
  { id: 'trident', name: 'Trident', tagline: 'TRIPLE SHOT', description: 'Three parallel lanes of fire. Cover a wider front without sacrificing range.', color: '#5fe7ff', interval: .16, damage: 1.38, speed: 82, pellets: 3, spread: .22, lifetime: 1.65, radius: .24 },
  { id: 'scatter', name: 'Scatter Cannon', tagline: 'SHOTGUN', description: 'Seven heavy pellets in a wide cone. Devastating up close; limited reach.', color: '#ffc67d', interval: .43, damage: 1.5, speed: 72, pellets: 7, spread: .85, lifetime: .43, radius: .34 },
  { id: 'rail', name: 'Rail Lance', tagline: 'PIERCING', description: 'Fast, heavy slugs punch through six enemies. Line up a crowd and erase it.', color: '#e1c4ff', interval: .4, damage: 5.76, speed: 175, pellets: 1, spread: 0, lifetime: 1, radius: .36, pierce: 5 },
  { id: 'seeker', name: 'Seeker Array', tagline: 'HOMING', description: 'Two guided missiles curve toward nearby targets. Keep moving while they hunt.', color: '#f895da', interval: .27, damage: 2.22, speed: 47, pellets: 2, spread: .3, lifetime: 2.4, radius: .36, homing: 5 },
  { id: 'ricochet', name: 'Prism Driver', tagline: 'RICOCHET', description: 'Twin bolts rebound off the arena walls three times and pierce one enemy.', color: '#90acff', interval: .23, damage: 2.04, speed: 67, pellets: 2, spread: .22, lifetime: 2.8, radius: .28, bounces: 3, pierce: 1 },
  { id: 'nova', name: 'Nova Ring', tagline: '360° BURST', description: 'Twelve projectiles radiate in every direction. Surrounding you is a mistake.', color: '#ff9eaa', interval: .65, damage: 1.98, speed: 48, pellets: 12, spread: Math.PI * 2, lifetime: 1, radius: .3 },
  { id: 'flame', name: 'Cinder Jet', tagline: 'BURN', description: 'A short cone of piercing fire. Scorches enemies for damage over time.', color: '#ff9c59', interval: .075, damage: .504, speed: 45, pellets: 3, spread: .42, lifetime: .34, radius: .55, pierce: 2, burn: 1.08 },
  { id: 'tesla', name: 'Arc Emitter', tagline: 'CHAIN LIGHTNING', description: 'Electric bolts leap to three nearby enemies. Built to break up a swarm.', color: '#96edff', interval: .29, damage: 2.28, speed: 120, pellets: 1, spread: 0, lifetime: .8, radius: .27, chain: 3 },
  { id: 'mortar', name: 'Sunburst Mortar', tagline: 'EXPLOSIVE', description: 'Slow shells explode on impact or at maximum range, damaging a wide area.', color: '#ffe18a', interval: .48, damage: 4.32, speed: 42, pellets: 1, spread: 0, lifetime: 1.1, radius: .65, blast: 5.5 },
];
