...
export const RELICS: RelicDef[] = [
  ...
  { id: 'rupture', name: 'Rupture Lens', category: 'CRITICAL', stat: 'critDamage', base: .5, maxStacks: 3, describe: v => `+${pct(v)} critical-damage bonus. Added to the base 200%.` },
  { id: 'piercing', name: 'Phase Rounds', category: 'PROJECTILE', stat: 'pierce', base: 1, integer: true, maxStacks: 3, describe: v => `Pierce ${v} more ${v === 1 ? 'enemy' : 'enemies'} per shot. 15 maximum.` },
  { id: 'refractor', name: 'Mirror Coating', category: 'PROJECTILE', stat: 'bounces', base: 1, integer: true, maxStacks: 3, describe: v => `+${v} wall ${v === 1 ? 'bounce' : 'bounces'} per shot. 8 maximum.` },
  { id: 'guidance', name: 'Targeting Matrix', category: 'PROJECTILE', stat: 'homing', base: 1.6, maxStacks: 3, describe: v => `Shots track enemies. +${num(v)} homing strength.` },
  { id: 'volatile', name: 'Volatile Payload', category: 'EXPLOSIVE', stat: 'blast', base: 1.7, maxStacks: 3, describe: v => `Explosive hits: +${num(v)} blast radius. Nearby enemies take 65% damage.` },
  { id: 'conductor', name: 'Storm Conductor', category: 'ELECTRIC', stat: 'chain', base: 1, integer: true, maxStacks: 3, describe: v => `Chain to ${v} more ${v === 1 ? 'enemy' : 'enemies'}. 65% damage per hop; 7 hops maximum.` },
  { id: 'incendiary', name: 'Ember Rounds', category: 'FIRE', stat: 'burn', base: .65, maxStacks: 3, describe: v => `+${num(v)} burn damage/sec for 3 seconds. Scales with weapon damage.` },
  ...
  { id: 'aegis', name: 'Aegis Generator', category: 'DEFENSE', stat: 'shieldRegen', base: 1, integer: true, maxStacks: 2, describe: v => `+${v} ${v === 1 ? 'shield' : 'shields'} each wave, starting next wave. 6 maximum.` },
  ...
  { id: 'reactor', name: 'Ordnance Reactor', category: 'SUPPLY', stat: 'bombRegen', base: .25, maxStacks: 2, describe: v => `+${num(v)} bombs per cleared wave. Fractions carry over.` },
  ...
  { id: 'vampire', name: 'Soul Circuit', category: 'DEFENSE', stat: 'vampiric', base: 1, integer: true, maxStacks: 2, describe: v => `Every 50 kills: +${v} ${v === 1 ? 'shield' : 'shields'}. 6 maximum.` },
  ...
  { id: 'rebound', name: 'Rebound Amplifier', category: 'SYNERGY', stat: 'rebound', base: .35, maxStacks: 3, describe: v => `+${pct(v)} damage per wall bounce, up to 3 times. Requires ricochets.` },
  ...
  { id: 'fusillade', name: 'Combat Package', category: 'OFFENSE', stat: 'damage', base: .16, maxStacks: 3, describe: v => `All weapons: +${pct(v)} damage bonus; +${pct(v / 2)} fire-rate bonus.` },
];
